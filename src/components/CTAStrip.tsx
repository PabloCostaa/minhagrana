      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          <motion.h3
            ...
            className="text-lg font-bold text-lime-accent font-editorial"
          >
            Controle seus gastos. Alcance suas metas.
          </motion.h3>
          ...
          >
            ...
            <span className="text-sm text-light-text-secondary dark:text-dark-text-secondary">Avaliação dos usuários</span>
          </motion.div>
        </div>
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-light-text dark:text-dark-text">Baixar App</span>
          </motion.button>
